...
function getInitialImageList() {
  ...
  // Add starter tile to the list
  tileImages.push("http://russcon.org/RussCon/carcassonne/city1rwe.png");
...
function getCastleImage() {
  var castleImage = "http://clipartion.com/wp-content/uploads/2015/12/castle-clip-art-images-free-for-commercial-use1.png";
  return castleImage
}

function getBridgeImage() {
  var bridgeImage = "http://findicons.com/files/icons/977/rrze/720/bridge_stone.png";
  return bridgeImage
}
